            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    <input type="password" id="password-new" name="password-new" class="form-control"
                           autofocus autocomplete="new-password"  style="height:40px"
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div id="kc-form-buttons" >
                    <#if isAppInitiatedAction??>
                        ...
                        <button class="btn btn-primary w-100" style="background-image: none;"  type="submit" name="cancel-aia" value="true" />${msg("doCancel")}</button>
                    <#else>
                        <input class="btn btn-primary w-100" style="background-image: none;" type="submit" value="${msg("doSubmit")}" />
                    </#if>
                </div>
