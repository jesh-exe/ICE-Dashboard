...
@Component({
  selector: "app-wgs-curation-dashboard",
  templateUrl: "./wgs-curation-dashboard.component.html",
  styleUrls: ["./wgs-curation-dashboard.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class WgsCurationDashboardComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.service.getAllWGSCurationList().subscribe(
